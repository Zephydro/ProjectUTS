...
if (isset($_POST['register'])) {
    ...
    $query = "INSERT INTO users (username, password, jenis_kelamin) VALUES ('$username', '$password', '$jenis_kelamin')";
    ...
    <div class="container">
        ...
        <div class="form-section">
            ...
            <form method="POST">
                ...
                <button type="submit" name="register" class="btn btn-primary">Daftar Pasien</button>
            </form>
            <p class="mt-2"> Anda Sudah terdaftar <a href="index.php" style="text-decoration: none;">Masuk pasien</a></p>
        </div>
    </div>
